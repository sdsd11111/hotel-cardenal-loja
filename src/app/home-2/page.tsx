...
export const metadata: Metadata = {
    title: 'Hotel El Cardenal Loja | Home 2',
    ...
    alternates: {
        canonical: 'https://hotelelcardenalloja.com/home-2',
    }
};
...
export default function Home2Page() {
    return (
        <>
            {/* 🚀 Visual Interactive Component with custom logo and theme */}
            <HomeClient
                customLogo="/images/home-2/Logo-home-2.png"
                themeClass="theme-home-2"
            />

            {/* 🤖 LLM & SEO Hidden Content (Same as main Home) */}
            <div
                style={{
                    position: 'absolute',
                    left: '-10000px',
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "image": "https://hotelelcardenalloja.com/images/home-2/Logo-home-2.png",
                        "@id": "https://hotelelcardenalloja.com/home-2",
                        "url": "https://hotelelcardenalloja.com/home-2",
