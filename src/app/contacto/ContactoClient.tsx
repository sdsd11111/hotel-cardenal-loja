                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    {esReservaHabitacion && (
                                        <>
                                            ...
                                            {/* Bloque 2: Facturación y Requerimientos (Accordion Style) */}
                                                ...
                                                <div className={`bg-gradient-to-r ${formData.deseaFacturacion ? 'from-cardenal-gold/10 to-cardenal-green/5' : 'from-amber-50 to-orange-50'} border-2 ${formData.deseaFacturacion ? 'border-cardenal-gold' : 'border-amber-300'} rounded-none shadow-lg overflow-hidden transition-all duration-500 hover:shadow-xl relative`}>
                                                    ...
                                                    >
                                                        <div className="flex items-center gap-4">
                                                            ...
                                                            <div>
                                                                <h3 className="text-lg font-bold text-cardenal-green font-serif">¿Necesita Factura o Tiene Requerimientos?</h3>
                                                                <p className="text-sm text-amber-700 font-medium mt-0.5">👆 Click aquí para facturación, mascotas o solicitudes especiales</p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div className={`transition-all duration-500 ease-in-out overflow-hidden ${formData.deseaFacturacion ? 'max-h-[1000px] opacity-100 p-6 pt-2' : 'max-h-0 opacity-0'}`}>
                                                        <div className="space-y-6">
                                                            ...
                                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 p-5 bg-gray-50/50 rounded-none border border-gray-100">
                                                                ...
                                                                <div>
                                                                    <label htmlFor="identificacion" className="block text-xs font-bold text-gray-600 mb-2 ml-1">Número de Identificación</label>
                                                                    <input
                                                                        type="text"
                                                                        id="identificacion"
                                                                        name="identificacion"
                                                                ...
                                                                <div className="md:col-span-2">
                                                                    <label htmlFor="razonSocial" className="block text-xs font-bold text-gray-600 mb-2 ml-1">Razón Social / Nombre Completo</label>
                                                                    <input
                                                                        type="text"
                                                                        id="razonSocial"
                                                                        name="razonSocial"
                                                                ...
                                                                <div className="md:col-span-2">
                                                                    <label htmlFor="direccionFacturacion" className="block text-xs font-bold text-gray-600 mb-2 ml-1">Dirección de Facturación</label>
                                                                    <input
                                                                        type="text"
                                                            ...
                                                            <div className="space-y-6 pt-4">
                                                                <label className="flex items-center gap-4 cursor-pointer group p-4 border-2 border-dashed border-gray-200 rounded-none hover:border-cardenal-gold/50 transition-all">
                                                                    ...
                                                                    <div>
                                                                        <span className="block text-sm font-bold text-gray-800">¿Trae mascota?</span>
