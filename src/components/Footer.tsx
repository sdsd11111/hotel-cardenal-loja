        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/" className="text-sm hover:text-white transition-colors flex items-center justify-center md:justify-start gap-2 font-body font-bold">
                  <span className="text-cardenal-gold font-bold">›</span> Inicio
                </Link>
              </li>
              <li>
                <Link href="/galeria" className="text-sm hover:text-white transition-colors flex items-center justify-center md:justify-start gap-2 font-body font-bold">
                  <span className="text-cardenal-gold font-bold">›</span> Galería
                </Link>
              </li>
              <li>
                <Link href="/habitaciones" className="text-sm hover:text-white transition-colors flex items-center justify-center md:justify-start gap-2 font-body font-bold">
                  <span className="text-cardenal-gold font-bold">›</span> Habitaciones
                </Link>
              </li>
              <li>
                <Link href="/servicios" className="text-sm hover:text-white transition-colors flex items-center justify-center md:justify-start gap-2 font-body font-bold">
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/politica-datos" className="text-sm hover:text-white transition-colors flex items-center justify-center md:justify-start gap-2 font-body font-black">
                  <span className="text-cardenal-gold font-bold">›</span> Protección de Datos (LOPDP)
                </Link>
              </li>
              <li>
                <Link href="/terminos" className="text-sm hover:text-white transition-colors flex items-center justify-center md:justify-start gap-2 font-body font-black">
                  <span className="text-cardenal-gold font-bold">›</span> Términos y Condiciones
                </Link>
              </li>
              <li>
                <Link href="/cookies" className="text-sm hover:text-white transition-colors flex items-center justify-center md:justify-start gap-2 font-body font-black">
          ...
          <div className="text-center md:text-left flex flex-col items-center md:items-start">
            ...
            <div className="mb-6 flex flex-col items-center md:items-start">
              <Link href="/" className="flex items-center gap-3 mb-4">
                ...
                <span className="text-xl font-black text-white font-serif tracking-tighter shadow-black/50 drop-shadow-md">Hotel El Cardenal</span>
              </Link>
